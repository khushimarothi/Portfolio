        ...
        <>
            <div id="contact" className="flex justify-center items-center lg:px-32 px-8 lg:py-20 py-10 bg-gradient-to-r from-black via-black to-gray-900 transition ease-in-out duration-1000" >
                <div className="container mx-auto">
                    ...
                    <div className='absolute overflow-hidden lg:-top-24 -top-2 left-0 w-full bg-blend-multiply z-20 '>
                <Image src={bg} alt='img'className='  w-full h-full object-fill z-0 ' style={{ opacity: 0.03}} />
                </div>
                        ...
                        <div className="flex flex-col flex-1 my-auto z-30">
