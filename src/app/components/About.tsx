...
<h1 className="lg:text-2xl text-lg font-semibold  pb-2 w-10 border-b-2 border-b-indigo-400">Participations</h1>
        <div className="">
 ...
 <div className="pb-3">
                        ...
                        {/* <div className="flex flex-col flex-1">
                            <h1 className="lg:text-2xl text-lg font-semibold mb-5 pb-2 w-10 border-b-2 border-b-indigo-400">Participations</h1>
        <div className="pb-3">
                            <div className='flex flex-row flex-wrap justify-between pb-1 '>
                                <h4 className="text-base">DesignUX - Organised by DoIT, RGPV </h4>
                                <p className="text-base">June 2021</p>
