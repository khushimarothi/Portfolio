            ...
            <div className="flex justify-center items-center lg:px-32 px-8 lg:pb-16 py-10 bg-gradient-to-r from-black via-black to-gray-900 ">
                ...
                <div className="container mx-auto">
                    ...
                    <div className="flex lg:flex-row flex-col justify-evenly  items-center lg:gap-16 gap-8 ">
                        ...
                        <div className="flex flex-col flex-1 gap-3 lg:-ml-36">
                            <h1 className="lg:text-3xl text-lg font-semibold pb-4 lg:text-right">Talent Tie</h1>

                            <div className="flex flex-row gap-5 lg:justify-end">
                                <div>
                                    <button className="px-4 py-2 border rounded-lg lg:text-base text-sm"> Source Code </button>
                                </div>
                                <div>
                                    <button className="px-4 py-2 border rounded-lg lg:text-base text-sm" > Live demo </button>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-row flex-wrap gap-3 items-center lg:justify-end">
                                <p className="px-3 py-1 border rounded-full lg:text-sm text-xs ">TypeScript</p>
                                <p className="px-3 py-1 border rounded-full lg:text-sm text-xs ">TailwindCSS</p>
                                <p className="px-3 py-1 border rounded-full lg:text-sm text-xs ">NextJs</p>
                            </div>
                        </div>

                    </div>

                    <div className="flex lg:flex-row flex-col justify-evenly  items-center lg:gap-16 gap-8 lg:pt-28 pt-14 ">
                        ...
                        <div className="flex flex-col flex-1 gap-3 lg:-mr-36 z-30 order-2 lg:order-1 ">
                            <h1 className="lg:text-3xl text-lg font-semibold pb-4 lg:text-left">Talent Tie</h1>
