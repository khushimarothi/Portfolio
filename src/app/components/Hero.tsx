...
const Hero = () => {
    ...
    return (
        <>
            <div  className="flex justify-center items-center lg:px-32 px-8 lg:py-16 py-10 h-screen  overflow-hidden from-purple-700 via-gray-900 to-black relative" style={backgroundStyles} >
